            ...
            <div className="menu flex" style={{
                ...
                <div className="menu-item w-full">
                    <form method="GET">
                        ...
                        <input className="search-input py-2 text-sm text-white pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Cari produk atau jasa..." autoComplete="off" onClick={() => router.push("/search")}/>
                        </div>
                    </form>
                </div>
