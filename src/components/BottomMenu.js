        ...
        <div>
            <section id="bottom-navigation" className="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
                <div id="tabs" className="flex justify-between">
                    <a target="_blank" href={"https://wa.me/085878565493?text=Hai,%20Admin!%20Saya%20tertarik%20dengan%20produk%20"} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1" style={{
